 ...
 **/
class GrdUserGroup extends GSearchGrid
{
    public $MIOLO;
    public $module;
    public $action;
    ...
    public function __construct($data)
    {
        ...
        $home = 'main:configuration:userGroup';
        ...
        $columns = array(
            ...
            new MGridColumn(_M('É visível à pessoa', $this->module),  MGrid::ALIGN_CENTER,null, NULL, true, GUtil::getYesNo(), true),
        );
