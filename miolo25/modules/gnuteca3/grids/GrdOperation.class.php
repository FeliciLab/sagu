 ...
 **/
class GrdOperation extends GSearchGrid
{
    public $MIOLO;
    public $module;
    public $action;
    ...
    public function __construct($data)
    {
        ...
        $home = 'main:configuration:operation';
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Define regra', $this->module),  MGrid::ALIGN_CENTER, null, null, true, GUtil::getYesNo(), true)
        );
