 ...
 **/
class GrdHelp extends GSearchGrid
{
    public $MIOLO;
    public $module;
    public $action;
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Subformulário', $this->module), MGrid::ALIGN_LEFT,   null, null, true, null, true),
            new MGridColumn(_M('Ajuda', $this->module), MGrid::ALIGN_LEFT, null, null, true, null, true),
            new MGridColumn(_M('Ativo', $this->module), MGrid::ALIGN_LEFT,   null, null, true, GUtil::getYesNo(), true)
        );
