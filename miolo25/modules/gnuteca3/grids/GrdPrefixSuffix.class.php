 ...
 *
 **/
class GrdPrefixSuffix extends GSearchGrid
{
    public $MIOLO;
    public $module;
    public $action;
    public $data;
    public $busPrefixSuffix;
    ...
    public function __construct($data)
    {
        ...
        $this->busPrefixSuffix = $this->MIOLO->getBusiness($this->module, 'BusPrefixSuffix');
        ...
        $columns = array(
            ...
            new MGridColumn( _M('Tipo', $this->module),      MGrid::ALIGN_CENTER,  null, null, true, $this->busPrefixSuffix->listTypes(), true )
        );
