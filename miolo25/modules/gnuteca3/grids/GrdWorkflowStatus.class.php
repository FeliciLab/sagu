 ...
 **/
class GrdWorkflowStatus extends GSearchGrid
{
    public $MIOLO;
    public $module;
    public $action;
    ...
    public function __construct($data)
    {
        ...
        $this->busTransaction = $this->MIOLO->getBusiness('admin','transaction');
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Inicial', $this->module), MGrid::ALIGN_LEFT,  GUtil::getYesNo(), null, true, null, true),
            new MGridColumn(_M('Transação', $this->module), MGrid::ALIGN_LEFT,  null, null, false, null, true),
            new MGridColumn(_M('Transação', $this->module), MGrid::ALIGN_LEFT,  null, null, true, null, true)
        );
        
        parent::__construct($data, $columns);

        $args = array( 'function' => 'update','workflowStatusId' => '%0%');
        $this->setIsScrollable();
        $this->addActionUpdate( $this->MIOLO->getActionURL($this->module, $this->action, null, $args) );
        $args = array( 'function' => 'delete','workflowStatusId' => '%0%');
    ...
    {
        $columns[3]->control[$i]->value = GUtil::getYesNo($columns[3]->control[$i]->value);
    }
}
?>