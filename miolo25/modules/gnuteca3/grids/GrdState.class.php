 ...
 *
 * */
class GrdState extends GSearchGrid
{
    ...
    {
        $columns = array(
            new MGridColumn(_M('UF', $this->module), MGrid::ALIGN_LEFT, null, null, true, null, true),
            ...
            new MGridColumn(_M('Código IBGE', $this->module), MGrid::ALIGN_LEFT, null, null, true, null, true),
        );

        parent::__construct($data, $columns);

        $args = array('function' => 'update', 'stateId' => '%0%');
        $this->setIsScrollable();
        $this->addActionUpdate($this->MIOLO->getActionURL($this->module, $this->action, null, $args));
        $args = array('function' => 'delete', 'stateId' => '%0%');
