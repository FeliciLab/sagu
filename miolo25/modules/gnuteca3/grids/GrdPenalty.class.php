...
class GrdPenalty extends GSearchGrid
{
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Data da penalidade', $this->module),      MGrid::ALIGN_LEFT,   null, null, true, null, true, MSort::MASK_DATETIME_BR),
            new MGridColumn(_M('Data final de penalidade', $this->module),  MGrid::ALIGN_LEFT,   null, null, true, null, true, MSort::MASK_DATETIME_BR),
