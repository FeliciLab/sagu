...
class GrdLocationForMaterialMovement extends GSearchGrid
{
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Forçar recibo de empréstimo por e-mail', $this->module),   MGrid::ALIGN_CENTER, null, null, true,  $yn, true),
            new MGridColumn(_M('Forçar recibo de renovação por e-mail', $this->module),  MGrid::ALIGN_CENTER, null, null, true,  $yn, true),
            new MGridColumn(_M('Forçar recibo de devolução por e-mail', $this->module), MGrid::ALIGN_CENTER, null, null, true,  $yn, true)
        );
