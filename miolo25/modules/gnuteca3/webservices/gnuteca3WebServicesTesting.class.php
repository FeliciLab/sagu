...
class gnuteca3WebServicesTesting extends GWebServices
{
    ...
    /**
     * Teste básico retorna string 'basicTest'
     * 
     * @return string 'basicTest'
     */
    ...
    public function getWebServiceObject($clientId, $clientPassword)
    {
        parent::__setClient($clientId, $clientPassword);

        if(!parent::__checkMethod("getWebServiceObject", false))
        {
            return parent::__getErrorStr();
        }

        $result = parent::__getWebService();
