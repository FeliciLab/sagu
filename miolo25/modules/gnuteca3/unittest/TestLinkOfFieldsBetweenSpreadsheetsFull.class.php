...
class TestLinkOfFieldsBetweenSpreadsheets extends GBusinessUnitTest
{
    public function setUp()
    {
        parent::setUp('LinkOfFieldsBetweenSpreadsheets');
        
        $data = new stdClass();
        $data->category = $data->categoryS = 'BK';
        $data->level = $data->levelS = '#';
        $data->tag = $data->tagS = '666';
        $data->categorySon = $data->categorySonS = 'BK';
        $data->levelSon = $data->levelSonS = '#';
        $data->tagSon = $data->tagSonS = '666.b';
