...
class TestSpreadsheet extends GBusinessUnitTest
{
    public function setUp()
    {
        ...
        $data->required = $data->requiredS = 'ad';
        $data->repeatFieldRequired = $data->repeatFieldRequiredS = 'asd';
        $data->defaultValue = $data->defaultValueS = 'asd';
        $data->menuName = $data->menuNameS = 'asd';
        $data->menuOption = $data->menuOptionS = '1';
        $data->menuLevel = $data->menuLevelS = '3';
