...
class TestTag extends GBusinessUnitTest
{
    public function setUp()
    {
        ...
        $data->observation = $data->observationS = 'DemonizedTest';
        $data->isRepetitive = $data->isRepetitiveS = 'f';
        $data->hasSubfield = $data->hasSubfieldS = 'f';
        $data->isActive = $data->isActiveS = 't';
        $data->inDemonstration = $data->inDemonstrationS = 't';
        $data->isObsolete = $data->isObsoleteS = 't';
        $data->helpX = $data->helpXS = 'Svard';
