...
class TestFormContent extends GBusinessUnitTest
{
    public function setUp()
    {
        parent::setUp('FormContent');
        
        $data = new stdClass();
        $data->operator = $data->operatorS = '';
        $data->form = $data->_formS = 'form';
        $data->_name = $data->_nameS = '';
        $data->description = $data->descriptionS = '';
        $data->formContentType = $data->formContentTypeS = '1';
