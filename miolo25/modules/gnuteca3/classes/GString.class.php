...
class GString
{
     ...
     *
     * @deprecated since version 3.4.4 - Comportamento da troca de + por '' esta 
     * sobre questionamento. Se quiser remover acentuacoes, utilize unaccent
     * 
     * @return GString
     */
    ...
    * @param object $var
    */
    public static function remAcento($var) 
    {
        $s = new GString();
        $s->string = $var;
        $s->toASCII();
    ...
    function unaccent()
    {
        $this->string = preg_replace('~&([a-z]{1,2})(?:acute|cedil|circ|grave|lig|orn|ring|slash|th|tilde|uml|caron);~i', '$1', htmlentities($this->string, ENT_COMPAT, $this->encoding));
