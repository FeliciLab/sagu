...
class comunicarAtrazados extends GTask
{
    ...
    function __construct($MIOLO, $myTaskId)
    {
        ...
        $this->busLoan = $MIOLO->getBusiness($MIOLO->getCurrentModule(), 'BusOperationLoan');
    ...
    public function execute()
    {
    	...
    	$this->busLoan->communicateDelayedLoan( $libraries );
        return true;
    }
