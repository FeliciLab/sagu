 ...
 *
 **/
class FrmMaterialTypeSearch extends GForm
{
    public function __construct()
    {
        $this->setAllFunctions('MaterialType', array('descriptionS'), array('materialTypeId'));
        parent::__construct();
    }

    public function mainFields()
    {
        $fields[] = new MTextField('materialTypeIdS', null, _M('Código', $this->module), FIELD_ID_SIZE);
        ...
        $fields[] = new MTextField('levelS', null, _M('Nível', $this->module), FIELD_ID_SIZE);
