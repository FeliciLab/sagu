...
class FrmState extends GForm
{
    ...
    {
        $this->setAllFunctions('State', null, array('stateId'), array('stateName'));
        parent::__construct();
    }
    ...
    public function mainFields()
    {
        ...
        $fields[] = $stateId = new MTextField('stateId', null, _M('UF', $this->module), FIELD_ID_SIZE, _M('2 Caracteres', $this->module));
