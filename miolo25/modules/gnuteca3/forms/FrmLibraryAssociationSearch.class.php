 ...
 *
 * @since
 * Class created on 11/ago/08
 *
 **/
class FrmLibraryAssociationSearch extends GForm
{
	public $MIOLO;
	public $module;
    ...
    public function __construct()
    {
        ...
        $this->setAllFunctions('Association', array('description'),array('associationId'));
        parent::__construct();
    }
    ...
    {
        $fields[] = new MTextField("associationIdS",   null,  _M("Código",  $this->module), FIELD_ID_SIZE);
