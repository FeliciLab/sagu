...
*
**/
defaultHandler('main:configuration:requestChangeExemplaryStatus', _M('Requisição de alteração de estado do exemplar', $module),null, null, 'requestChangeExemplaryStatus-16x16.png' );
?>
