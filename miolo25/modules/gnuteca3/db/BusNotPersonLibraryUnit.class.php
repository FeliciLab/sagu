 ...
 *
 **/
class BusinessGnuteca3BusNotPersonLibraryUnit extends GBusiness
{
    ...
    {
    	return $this->busPersonLibraryUnit->checkAccess($personId, $libraryUnitId) ? FALSE : TRUE;
    }
}
?>
