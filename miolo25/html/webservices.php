...
$wsdlFile = "html/files/wsdl/$class.wsdl";
//$wsdlFile = "/modules/gnuteca3/webservices/wsdl/$class.wsdl";
$wsdlPath = $MIOLO->getModulePath( $currentModule, $wsdlFile );
...
file_put_contents('/tmp/pathw', $wsdl, FILE_APPEND);
...
$path = $MIOLO->getModulePath( $currentModule, $file );
