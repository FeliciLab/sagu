...
var imgDir = "/themes/ufjf/popupcalendar/" // directory for images ... e.g. var imgDir="/img/"

var gotoString = "Clique para ver este mês"
var todayString = "Hoje é"
var weekString = "Semana"
var scrollLeftMessage = "Mês anterior. Segure o mouse para rolar automaticamente."
var scrollRightMessage = "Mês posterior. Segure o mouse para rolar automaticamente."
var selectMonthMessage = "Selecione o mês."
var selectYearMessage = "Selecione o ano."
var selectDateMessage = "Selecione [date]" // do not replace [date], it will be replaced by date.
    ...
    if (!ns4)
        ...
        if (showToday == 1)
            ...
            document.getElementById("lblToday").innerHTML
                = todayString
                      + " <a onmousemove='window.status=\""+gotoString+"\"' onmouseout='window.status=\"\"' title='"+gotoString+"' style='"+styleAnchor+"' href='javascript:monthSelected=monthNow;yearSelected=yearNow;constructCalendar();'>" + dayName[(today.getDay() - startAt == -1)
                                                                                                                                                                                                                                                      ? 6
                                                                                                                                                                                                                                                      : (today.getDay() - startAt)] + ", " + dateNow + " "
