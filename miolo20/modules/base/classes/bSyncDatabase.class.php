...
class bSyncDatabase extends SimpleXMLElement implements bSync
{
    ...
    public static function runSyncScript($syncModule)
    {
        ...
        //caso exista script de sincronizacao, executa-o
    ...
    public static function executeSQLChanges($syncModule)
    {
        $MIOLO = MIOLO::getInstance();
        ...
        foreach ( $files as $line => $file )
        {
            ...
            {
                $versao = file_get_contents($MIOLO->getModulePath('basic', 'VERSION'));
