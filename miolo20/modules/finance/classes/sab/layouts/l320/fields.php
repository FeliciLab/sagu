...
class fieldsStruct extends fields
{
    ...
    */
    public function generateBarCode(sabStruct $sabStruct)
    {
        ...
        $this->barCodeData->setBarCodeField('transferorAgreement' , $sabStruct->getTransferorAgreement()         , 5, 0);
        $this->barCodeData->setBarCodeField('invoiceNumber'       , $sabStruct->getInvoiceOurNumber()            , 6, 0);
