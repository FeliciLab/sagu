...
class fieldsStruct extends fields
{
    ...
    */
    public function generateBarCode(sabStruct $sabStruct)
    {
        ...
        $this->barCodeData->setBarCodeField('codeAplicationRecovery', $sabStruct->getCodeAplicationRecoveryDVM10(),  1, 0);
        $this->barCodeData->setBarCodeField('invoiceNumber' , $sabStruct->getInvoiceNumber(), 13, 0);
