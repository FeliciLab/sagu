...
class sabStruct extends sabCore
{
    ...
    */
    ...
    {
        parent::__construct('356');
        $this->setBankCode('356');
        $this->setBankDV('5');
        $this->setInvoiceNumber('1234567890');
        
        //Define wallet
        $this->setInvoiceWallet('9');
        ...
        {
            $this->setPaymentPlaceDescription(_('Pague preferencialmente nas agências do Banco Real'));
        }
    ...
    */
    ...
    /**
     * Return the code aplication recovery of the field free
     *
     * @return: $codeAplicationRecoveryDV (integer); Is digit verifier
     **/
    function getCodeAplicationRecoveryDVM10()
    {
        $codeAplicationRecoveryDV  = $this->getInvoiceOurNumber();
        $codeAplicationRecoveryDV .= $this->getTransferorBankAccount();
        $codeAplicationRecoveryDV .= $this->getTransferorCode();

        return fields::modulo10($codeAplicationRecoveryDV);
    }
