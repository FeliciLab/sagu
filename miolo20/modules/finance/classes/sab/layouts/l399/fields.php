...
class fieldsStruct extends fields
{
    ...
    */
    public function generateBarCode(sabStruct $sabStruct)
    {
        ...
        $this->barCodeData->setBarCodeField('invoiceNumber' , $sabStruct->getInvoiceOurNumber(), 10, 0);
        $this->barCodeData->setBarCodeField('invoiceNumberDV' , $this->modulo11($sabStruct->getInvoiceOurNumber()), 1, 0);
        $this->barCodeData->setBarCodeField('bankAccount'   , $sabStruct->getTransferorBankAccount(),  4, 0);
        $this->barCodeData->setBarCodeField('transferorCode', $sabStruct->getTransferorCode(),  7, 0);
        $this->barCodeData->setBarCodeField('wallet', $sabStruct->getInvoiceWallet()               ,  2, 0);
        $this->barCodeData->setBarCodeField('codeAplicationRecovery', $sabStruct->getValueCodeAplicationRecovery(),  1, 0);
        $this->barCodeData->setBarCodeField('barCodeDV'     , $this->modulo11(self::onlyNumbers($this->barCodeData->returnBarCode()), 2, 7), 1, 0);
    }
}
?>
