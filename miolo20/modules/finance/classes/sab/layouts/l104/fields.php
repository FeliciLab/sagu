...
class fieldsStruct extends fields
{
    ...
    */
    public function generateBarCode(sabStruct $sabStruct)
    {
        ...
        if ( strlen($sabStruct->getInvoiceOurNumber()) == 8 )
        {
            $this->barCodeData->setBarCodeField('wallet'        , $sabStruct->getInvoiceWallet()        , 2, 0);
            $this->barCodeData->setBarCodeField('invoiceNumber' , $sabStruct->getInvoiceOurNumber()     , 8, 0);
            $this->barCodeData->setBarCodeField('transferorBank', $sabStruct->getTransferorBankAccount(), 4, 0);
            $this->barCodeData->setBarCodeField('codeProvideAg' , $sabStruct->getCodeProvideAg()        , 11, 0);
            $this->barCodeData->setBarCodeField('barCodeDV'     , $this->modulo11(self::onlyNumbers($this->barCodeData->returnBarCode())), 1, 0);
        }
        elseif ( strlen($sabStruct->getInvoiceOurNumber()) == 14 )
        {
            $this->barCodeData->setBarCodeField('transferorCode', $sabStruct->getTransferorCode()       ,  5, 0);
            $this->barCodeData->setBarCodeField('transferorBank', $sabStruct->getTransferorBankAccount(),  4, 0);
            $this->barCodeData->setBarCodeField('wallet'        , $sabStruct->getInvoiceWallet()        ,  1, 0);
            $this->barCodeData->setBarCodeField('constant'      , 7                                     ,  1, 0);
            $this->barCodeData->setBarCodeField('invoiceNumber' , $sabStruct->getInvoiceOurNumber()     , 14, 0);        
            $this->barCodeData->setBarCodeField('barCodeDV'     , $this->modulo11(self::onlyNumbers($this->barCodeData->returnBarCode())), 1, 0);
        }
        elseif (strlen($sabStruct->getInvoiceOurNumber()) == 15 )
        {
            $this->barCodeData->setBarCodeField('transferorCode'  , $sabStruct->getTransferorCode()                 ,  6, 0);
            $this->barCodeData->setBarCodeField('transferorCodeDV', $this->modulo11($sabStruct->getTransferorCode()),  1, 0);
            $this->barCodeData->setBarCodeField('invoiceNumber1'  , substr($sabStruct->getInvoiceOurNumber(), 0, 3) ,  3, 0);
            $this->barCodeData->setBarCodeField('isRegister'      , $sabStruct->getIsRegister()                     ,  1, 0);
            $this->barCodeData->setBarCodeField('invoiceNumber2'  , substr($sabStruct->getInvoiceOurNumber(), 3, 3) ,  3, 0);
            $this->barCodeData->setBarCodeField('sentTransferor'  , $sabStruct->getSentTransferor()                 ,  1, 0);
            $this->barCodeData->setBarCodeField('invoiceNumber3'  , substr($sabStruct->getInvoiceOurNumber(), 6, 9) ,  9, 0);
            $this->barCodeData->setBarCodeField('freeFieldsDV'    , $sabStruct->getFreeFieldsDVM11()                ,  1, 0);
            $this->barCodeData->setBarCodeField('barCodeDV'       , $this->modulo11(self::onlyNumbers($this->barCodeData->returnBarCode())), 1, 0);
        }
    }
}
