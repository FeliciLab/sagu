...
class fieldsStruct extends fields
{
    ...
    */
    public function generateBarCode(sabStruct $sabStruct)
    {
        ...
        $this->barCodeData->setBarCodeField('invoiceNumber'   , $sabStruct->getInvoiceOurNumber()       , 9, 0);
        $this->barCodeData->setBarCodeField('transferorBank'  , $sabStruct->getTransferorBankAccount()  , 4, 0);
        $this->barCodeData->setBarCodeField('transferorBankDV', $sabStruct->getTransferorBankAccountDV(), 2, 0);
        $this->barCodeData->setBarCodeField('transferorCode'  , $sabStruct->getTransferorCode()         , 5, 0);
        $this->barCodeData->setBarCodeField('filter1'         , $sabStruct->getValueExpressedField()    , 1, 0);
        $this->barCodeData->setBarCodeField('filter2'         , 0                                       , 1, 0);
