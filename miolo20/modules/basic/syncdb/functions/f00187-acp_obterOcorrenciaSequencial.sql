CREATE OR REPLACE FUNCTION acp_obterOcorrenciaSequencial(p_ofertacomponentecurricularid int, p_gradehorarioid int, p_iniciodasaulas date, p_datassemaula date[])
