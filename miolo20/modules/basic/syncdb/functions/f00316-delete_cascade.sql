CREATE OR REPLACE FUNCTION delete_cascade(p_tabela TEXT, p_esquema TEXT, p_chave TEXT)
 RETURNS boolean AS
$BODY$
BEGIN
RETURN true;
...
/******************************************************************************
  ...
  tabela (podendo chamar a função dentro da função)
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION delete_cascade(text, text, text)
  OWNER TO postgres;
