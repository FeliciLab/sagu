/*************************************************************************************
  NAME: obtemValorComDescontoDeContratoQueTenhaIncentivo
  PURPOSE: Obtém valor com desconto de um contrato que tenha incentivo.
  AUTOR: Nataniel Ingor da Silva
**************************************************************************************/
CREATE OR REPLACE FUNCTION obtemValorComDescontoDeContratoQueTenhaIncentivo(p_contractid integer, p_incentiveid integer)
  RETURNS float AS
$BODY$
...
BEGIN
    ...
    RETURN v_incentivo.valorcomdesconto;
END;
$BODY$
  LANGUAGE plpgsql;
--
