CREATE OR REPLACE FUNCTION totalCounterMovement(p_counterId finCounter.counterId%TYPE, p_beginDate date, p_endDate date, p_specieId finCounterMovement.speciesId%TYPE, p_operation finCounterMovement.operation%TYPE)
  RETURNS numeric AS
$BODY$
/*************************************************************************************
