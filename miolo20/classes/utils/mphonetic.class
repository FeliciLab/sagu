...
class MPhonetic
{
    ...
    {
        $acento['Á'] = $acento['Ã'] = $acento['Â'] = $acento['À'] = 'A';
        $acento['É'] = $acento['È'] = $acento['Ê'] = 'E';
        $acento['Ó'] = $acento['Ò'] = $acento['Õ'] = $acento['Ô'] = 'O';
        $acento['Í'] = $acento['Ì'] = $acento['Î'] = 'I';
        $acento['Ú'] = $acento['Ù'] = $acento['Û'] = 'U';
        $acento['Ñ'] = 'N';
        $acento['Ç'] = 'SS';
        $len = strlen($word);
        $result = '';
