                    ...
                    foreach ( $columns as $line => $column )
                    {
                        ...
                        if ( $column->visible == true )
                        {
                            if ( $column->options )
                            {
                                ...
                                if ( !$readOnly )
                                {
                                    // Comentei esta linha para o alinhamento em subdetails se comportar corretamente.
                                    // Nao estava alinhando a primeira linha de acordo com o especificado no MGridColumn->align.
//                                    $aplyCellAttributeId = $i + 1;
    ...
    public static function addToTable($data)
    {
        ...
        foreach ( $validators as $validator )
        {
            ...
            {
                new MMessageWarning(_M('Faltando campos obrigatórios!'));
                return;
            }
        }
