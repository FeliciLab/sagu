...
class MMessage
{
     ...
     */
    public function __construct($message, $type = self::TYPE_INFORMATION, $display = true, $msgContainer = self::MSG_CONTAINER_ID, $animate = true, $hideTime = 5000)
    {
        $MIOLO = MIOLO::getInstance();
    ...
    public static function getMessageContainer()
    {
	    ...
	    $hideFunction = "mmessage.hideMessageDiv(\'". self::MSG_DIV_ID ."\', \'$animate\')";
            $jsCode .= " window.setTimeout('$hideFunction', 5000);";
