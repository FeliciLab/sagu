...
ALTER TABLE "ava_usuario" ALTER COLUMN "id_usuario" SET NOT NULL;
ALTER TABLE "ava_usuario" ALTER COLUMN "nome" SET NOT NULL;

ALTER TABLE "ava_usuario" ALTER COLUMN "id_usuario" SET NOT NULL;
ALTER TABLE "ava_usuario" ADD PRIMARY KEY ("id_usuario");
...
ALTER TABLE "ava_respostas" ADD FOREIGN KEY ("ref_avaliador") REFERENCES "ava_usuario"("id_usuario");

ALTER TABLE "ava_respostas" ADD FOREIGN KEY ("ref_avaliado") REFERENCES "ava_usuario"("id_usuario");
